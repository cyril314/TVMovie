...
public final class GridLayoutManager extends RecyclerView.LayoutManager {
    ...
    protected void setFocusPosition(int position) {
        ...
        if (mRowSizeSecondaryRequested == ViewGroup.LayoutParams.WRAP_CONTENT) {
            ...
            switch (modeSecondary) {
                ...
                case View.MeasureSpec.EXACTLY:
                    ...
                    if (modeSecondary == View.MeasureSpec.AT_MOST) {
    ...
    void measureChild(View child) {
        ...
        final int secondarySpec =
                (mRowSizeSecondaryRequested == ViewGroup.LayoutParams.WRAP_CONTENT)
                        ? View.MeasureSpec.makeMeasureSpec(0, View.MeasureSpec.UNSPECIFIED)
                        : View.MeasureSpec.makeMeasureSpec(mFixedRowSizeSecondary, View.MeasureSpec.EXACTLY);
    ...
    public void onLayoutChildren(RecyclerView.Recycler recycler, RecyclerView.State state) {
        ...
        if (mFocusPosition != NO_POSITION && scrollToFocus
                && mBaseGridView.getScrollState() != SCROLL_STATE_IDLE) {
            ...
            // Log.e(TAG,"focusView.requestFocus();---------------");
        }
    ...
    public View onInterceptFocusSearch(View focused, int direction) {
        ...
        final boolean isScroll = mBaseGridView.getScrollState() != SCROLL_STATE_IDLE;
     ...
     */
    @Override
    public boolean performAccessibilityAction(RecyclerView.Recycler recycler, RecyclerView.State state, int action,
                                              Bundle args) {
        saveContext(recycler, state);
        switch (action) {
    ...
    @Override
    public void onInitializeAccessibilityNodeInfo(RecyclerView.Recycler recycler, RecyclerView.State state,
