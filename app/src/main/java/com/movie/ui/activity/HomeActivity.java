...
import com.movie.ui.adapter.HomePageAdapter;
import com.movie.ui.adapter.SortAdapter;
import com.orhanobut.hawk.Hawk;
import com.movie.R;
import com.movie.base.BaseActivity;
import com.movie.base.BaseLazyFragment;
import com.movie.bean.AbsSortXml;
...
import com.movie.ui.dialog.UpdateHintDialog;
import com.movie.ui.fragment.GridFragment;
import com.movie.ui.fragment.UserFragment;
...
import com.movie.viewmodel.SourceViewModel;
...
public class HomeActivity extends BaseActivity {
                        ...
                        public boolean onKey(View v, int keyCode, KeyEvent event) {
                            if (event.getAction() == KeyEvent.ACTION_DOWN) {
                                ...
                                if (keyCode == KeyEvent.KEYCODE_DPAD_DOWN) {
                                    ...
                                    return keyCode == KeyEvent.KEYCODE_DPAD_LEFT && position == 0 || keyCode == KeyEvent.KEYCODE_DPAD_RIGHT && position == sortAdapter.getData().size() - 1;
                            }
                            return false;
                        }
                    });
    ...
    private final View.OnKeyListener keyListener = new View.OnKeyListener() {
        ...
        public boolean onKey(View v, int keyCode, KeyEvent event) {
            if (event.getAction() == KeyEvent.ACTION_DOWN) {
                ...
                } else return keyCode == KeyEvent.KEYCODE_DPAD_LEFT && v.getId() == R.id.tvLive;
            }
            return false;
        }
    };
    ...
    private void initData() {
        ...
        if (DefaultConfig.getAppVersionCode(mContext) > Hawk.get(HawkConfig.SHOW_UPDATE_HINT, 123)) {
