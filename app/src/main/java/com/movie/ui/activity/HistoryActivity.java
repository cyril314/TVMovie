...
import com.movie.event.HistoryStateEvent;
import com.movie.ui.adapter.HistorySourceAdapter;
                        ...
                        public boolean onKey(View v, int keyCode, KeyEvent event) {
                            if (event.getAction() == KeyEvent.ACTION_DOWN) {
                                ...
                                if (keyCode == KeyEvent.KEYCODE_DPAD_DOWN) {
                                    ...
                                    isDownOrUp = true;
                                } else return keyCode == KeyEvent.KEYCODE_DPAD_LEFT && position == 0 || keyCode == KeyEvent.KEYCODE_DPAD_RIGHT && position == sourceAdapter.getData().size() - 1;
                            }
                            return false;
                        }
                    });
